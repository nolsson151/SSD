...
<form action="Register" method="post">
	<p>First name: <input type="text" name="fname" required pattern="[a-z]{2,20}" title="Must be between 2 and 20 letters">
	<p>Last name: <input type="text" name="lname" required pattern="[a-z]{2,20}" title="Must be between 2 and 20 letters">
